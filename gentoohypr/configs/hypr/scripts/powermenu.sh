...
## MAIN ACTION COMMAND ##
action=$(echo -e "$options" | rofi -dmenu -theme /home/rjm/.config/rofi/launchers/type-6/style-10.rasi "                                        ")
case "$action" in
    $option1*)
         kill -9 -1;;
    $option2*)
    ...
    $option6*)
        ...
        pwraction=$(echo -e "$pwrs" | rofi -dmenu -theme /home/rjm/.config/rofi/launchers/type-6/style-10.rasi "
                                                        ")
        case "$pwraction" in
            $pwr1*)
